	...
	\begin{itemize}%
		\item Transformation vers l'IA
			\begin{itemize}%
				...
				\item Automatisation des processus de sécurité et de conformité en l'environnement cloud. Compliant ISO 27001 / 42001, SOC2, RGPD
	...
	\begin{itemize}%
		\item Transformation digitale vers le cloud
			\begin{itemize}%
				...
				\item Containérisation de l'application sous Docker et réaliser le déploiement sous Nomad et Kubernetes
			\end{itemize}
	\end{itemize}
\bigskip
	\begin{itemize}%
...
\cventry{2005-2007}{Société Générale Banque et Investissement via ESN}{SGCIB}{Paris}{}{}
{
