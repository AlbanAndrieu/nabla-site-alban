...
\begin{twentytimeline}
	\twentyitemtimeline{\faCloud}
		...
		\item \textbf{Sécurité infrastructure :} Analyse de vulnérabilités, gestion des secrets, contrôles d'accès, anti scraping. Première legaltech certifiée ISO 42001, 27001, SOC2, RGPD
		\item \textbf{Conteneurisation \& Nomad :} Images Docker, clusters Nomad et K8s (réseau, stockage, observabilité), définition de SLO/SLI
