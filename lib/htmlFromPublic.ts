...
const HTML_FILE_PATHS: { [filename: string]: string } = {
  "404.html": path.join(process.cwd(), "public", "404.html"),
  "ai.html": path.join(process.cwd(), "public", "ai.html"),
  "cancel.html": path.join(process.cwd(), "public", "cancel.html"),
  "checkout.html": path.join(process.cwd(), "public", "checkout.html"),
  "ciso.html": path.join(process.cwd(), "public", "ciso.html"),
  "contact.html": path.join(process.cwd(), "public", "contact.html"),
  "ctid.html": path.join(process.cwd(), "public", "ctid.html"),
  "cv/index.html": path.join(process.cwd(), "public", "cv/index.html"),
  "email.html": path.join(process.cwd(), "public", "email.html"),
  "expertise.html": path.join(process.cwd(), "public", "expertise.html"),
  "freenas.html": path.join(process.cwd(), "public", "freenas.html"),
  "index.html": path.join(process.cwd(), "public", "index.html"),
  "link.html": path.join(process.cwd(), "public", "link.html"),
  "login.html": path.join(process.cwd(), "public", "login.html"),
  "nabla.html": path.join(process.cwd(), "public", "nabla.html"),
  "payment.html": path.join(process.cwd(), "public", "payment.html"),
  "pricing.html": path.join(process.cwd(), "public", "pricing.html"),
  "security.html": path.join(process.cwd(), "public", "security.html"),
  "startup-thanks.html": path.join(
    process.cwd(),
    "public",
    "startup-thanks.html",
  ),
  "startup.html": path.join(process.cwd(), "public", "startup.html"),
  "success.html": path.join(process.cwd(), "public", "40success4.html"),
  "test.html": path.join(process.cwd(), "public", "test.html"),
  "truenas.html": path.join(process.cwd(), "public", "truenas.html"),
  "workstation.html": path.join(process.cwd(), "public", "workstation.html"),
};

type PublicHtmlFile = (typeof HTML_FILE_PATHS)[number];

function isPublicHtmlFile(file: string): file is PublicHtmlFile {
  return file in HTML_FILE_PATHS;
}
  ...
  subjectOf: [
    {
      ...
      url: "https://albanandrieu.com/cv/cv-aandrieu-2026.pdf",
    ...
    },
    {
      ...
      url: "https://albanandrieu.com/cv/linkedin/cv-aandrieu-linkedin-2026-01-01.pdf",
      encodingFormat: "application/pdf",
    },
    {
      "@type": "WebPage",
      ...
      url: "https://albanandrieu.com/cv/index.html",
    },
  ],
};
...
export async function loadPublicHtmlFragment(
  ...
  const full = HTML_FILE_PATHS[file];
  if (!full) {
    throw new Error(file + " not allowed for loadPublicHtmlFragment");
  }
  const html = await readFile(/*turbopackIgnore: true*/ full, "utf8");
...
export async function metadataFromPublicHtml(
  ...
  const normalizedPath = canonicalPath.startsWith("/")
    ? canonicalPath
    : `/${canonicalPath}`;
  const canonical = `https://albanandrieu.com${withLocalePrefix(normalizedPath, locale)}`;
