...
const overviewPath = new URL("../app/[locale]/ai/AiSecurePlatformOverview.tsx", import.meta.url);
const nativeSectionsPath = new URL("../app/[locale]/ai/AiNativeSections.tsx", import.meta.url);
...
test("AI page leads native content with secure platform engineering", async () => {
	...
	assert.match(nativeSections, /<AiSecurePlatformOverview locale=\{locale\} \/>/);
	assert.ok(
