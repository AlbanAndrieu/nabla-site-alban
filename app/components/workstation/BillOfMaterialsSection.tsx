		...
		<section className="category-section nabla-platforms-section bill-of-materials-section">
			<Container>
				<div className={styles.bomContent}>
					<h3 className={`${styles.bomTitle} hardware-bom-heading`}>
					...
					<h4
						className={`${styles.bomSubtitle} hardware-bom-heading hardware-bom-heading--sub`}
					>
						<span className="hardware-bom-heading__icon" aria-hidden="true">
					...
					<ul
						className={`${styles.bomList} ${styles.bomListSpaced} hardware-bom-list`}
					>
						{WORKSTATION_BOM.reused.map((item) => (
							<li
								key={item.name}
								className={`${styles.bomItem} hardware-bom-li`}
							>
					...
					<ul className={`${styles.bomList} hardware-bom-list`}>
