...
export const alt = "Alban Andrieu — DevSecOps, Cloud Security & AI Infrastructure";
		...
		(
			...
			>
				...
				>
					...
					>
						...
						<div style={{ display: "flex", flexDirection: "column" }}>
							<div style={{ fontSize: "28px", fontWeight: 750 }}>Alban Andrieu</div>
				...
				>
					...
					<div>{french ? "France · Europe · Remote" : "France · Europe · Remote"}</div>
				</div>
			</div>
		),
		{ ...size },
