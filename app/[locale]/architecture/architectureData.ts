...
export const AI_RELATIONS: ArchitectureRelation[] = [
	...(["openwebui", "openclaw", "opencode", "codex", "cursor"] as const).map(
		(source) => ({
			source,
			target: "litellm",
			type: "model requests",
...
export const NABLA_EXTERNAL_ENTITIES: ArchitectureEntity[] = [
	...
	},
	{
		...
		kind: "scm",
		category: "collaboration",
		url: "https://gitlab.com/AlbanAndrieu",
		icon: "🦊",
	},
	{
		id: "jira",
	...
	},
	{
		...
		kind: "knowledge",
		category: "collaboration",
		url: "https://app.notion.com/p/albandrieu/Getting-Started-d588a6b720254a7baebd45357e8315a3",
		icon: "📝",
	},
	{
		id: "reactive-resume",
		...
		kind: "application",
		category: "portfolio",
		url: "https://reactive-resume.albandrieu.com",
		icon: "📄",
	},
	{
		id: "fastapi-cloud",
	...
	{
		id: "docker-hub",
		name: "Docker Hub / Nabla",
		kind: "registry",
		category: "platform",
		url: "https://hub.docker.com/u/nabla",
		icon: "🐳",
	},
	{
		id: "ansible",
...
function serviceIconSrc(service: HomelabService): string | undefined {
	...
	return service.iconSrc.startsWith("/")
		? service.iconSrc
		: `/${service.iconSrc}`;
}
...
export function buildNablaRelations(
	topology: ServiceTopology,
