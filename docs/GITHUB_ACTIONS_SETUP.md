...
- GitHub Actions use `.nvmrc` (Node.js 26.8.2) and explicitly upgrade npm to 11.17.0. Vercel Functions remain on a Vercel-supported Node runtime (currently 24.x).
- npm `>=11.17.0 <12`.
